...
import ckRudisha from "@/assets/cocktails/rudisha nguvu.png";
...
export const boireCategories: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Castel Lite", price: "6 $", image: biCastelLite },
      { name: "Black Label", price: "6 $", image: biBlackLabel },
      { name: "Heineken", price: "6 $", image: biHeineken },
      { name: "Leffe", price: "8 $", image: biLeffe },
      { name: "Corona", price: "6 $", image: biCorona },
    ],
  },
  {
    slug: "cider",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Red Bull", price: "6 $", image: sfRedbull },
